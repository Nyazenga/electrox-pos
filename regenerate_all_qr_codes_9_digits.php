<?php
/**
 * Regenerate all QR codes with 9-digit receiptGlobalNo format
 */
...
echo "=== REGENERATING ALL QR CODES WITH 9-DIGIT receiptGlobalNo ===\n\n";
...
foreach ($receipts as $receipt) {
    try {
        ...
        // Regenerate QR code with 9-digit receiptGlobalNo
...
if ($updated > 0) {
    ...
    if ($sampleReceipt) {
        ...
        echo "\nYou can test this URL in a browser to verify it works.\n";
    }
}
