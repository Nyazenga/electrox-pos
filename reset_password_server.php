<?php
/**
 * Password Reset Script for Server
 * Resets password for tenant "primary" and email "nyazengamd@gmail.com"
...
// Define HASH_COST if not already defined (should match config.php)
