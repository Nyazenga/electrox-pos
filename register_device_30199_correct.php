...
$activationKey = '00544726'; // Correct activation key from ZIMRA
...
try {
    ...
    if (strpos($e->getMessage(), 'DEV02') !== false) {
        echo "\n  Device might already be registered. Trying to issue new certificate...\n";
        // If already registered, we'd need to use issueCertificate, but that requires auth
        echo "  You may need to contact ZIMRA to reset the device registration.\n";
    }
...
echo "\nDevice $deviceId is now ready for fiscalization!\n";
