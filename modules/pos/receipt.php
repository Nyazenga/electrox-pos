...
if (empty($receiptLogoPath)) {
    ...
    $defaultLogoFullPath = APP_PATH . '/' . ltrim($defaultLogoPath, '/');
    if (file_exists($defaultLogoFullPath)) {
    ...
    <table style="width: 100%; max-width: 100%; border-collapse: collapse; table-layout: auto;">
        ...
        <thead>
            <tr>
                ...
                <th style="text-align: center; padding: 6px 2px; border-bottom: 1px solid #ddd; white-space: nowrap;">Qty</th>
                <th style="text-align: right; padding: 6px 2px; border-bottom: 1px solid #ddd; white-space: nowrap;">Price</th>
                <th style="text-align: right; padding: 6px 2px; border-bottom: 1px solid #ddd; white-space: nowrap;">Total</th>
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align: center; padding: 6px 2px; border: 1px solid #ddd; border-top: none; border-left: none; white-space: nowrap;"><?= $item['quantity'] ?></td>
                    <td style="text-align: right; padding: 6px 2px; border: 1px solid #ddd; border-top: none; border-left: none; white-space: nowrap;"><?= $unitPriceFormatted ?></td>
                    <td style="text-align: right; padding: 6px 2px; border: 1px solid #ddd; border-top: none; border-left: none; white-space: nowrap;"><?= $totalPriceFormatted ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
        <tfoot>
